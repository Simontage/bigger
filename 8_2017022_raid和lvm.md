...
![pvcreate](http://pic.027cgb.cn/20170303/2017339692053794775.png “pvcreate”)

显示当前的物理卷使用pvs，显示详细信息可以使用pvdisplay [device]

![http://pic.027cgb.cn/20170303/2017331721252836184.png]()

**卷组的管理命令：vg***

创建卷组使用vgcreative 卷组名，-s选项可以指定PE大小，默认是4M

![http://om8bgr2y6.bkt.clouddn.com/vgcreative.PNG]()
...
缩减使用vgreduce（要配合pvmove使用），删除vg使用vgremove
